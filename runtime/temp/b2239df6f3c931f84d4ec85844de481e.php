        ...
        <fieldset>
            <div class="row">
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    ...
                    <div id='calendar_loading'>loading...</div>
                    <div id='calendar_duty'></div>
