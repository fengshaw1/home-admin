<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:90:"C:\Users\frank\Desktop\home-admin\public/../application/admin\view\owners\index\index.html";i:1661436820;s:86:"C:\Users\frank\Desktop\home-admin\public/../application/admin\view\layout\default.html";i:1661436820;s:83:"C:\Users\frank\Desktop\home-admin\public/../application/admin\view\common\meta.html";i:1661436820;s:98:"C:\Users\frank\Desktop\home-admin\public/../application/admin\view\owners\index\common_search.html";i:1661436820;s:85:"C:\Users\frank\Desktop\home-admin\public/../application/admin\view\common\script.html";i:1661436820;}*/ ?>
<!DOCTYPE html>
    ...
    <form class="form-horizontal form-commonsearch nice-validator n-default" role="form" action="" novalidate="novalidate">
        <fieldset>
            <div class="row">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <label class="control-label col-xs-4"><?php echo __('Birth'); ?>:</label>
                    <div class="col-xs-12 col-sm-8">
                        <div class="row row-between">
                            <div class="col-xs-6 11" style="position: relative;width:49%;">
                                <input type="text" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" name="query[birth_begin]" value="" />
                            </div>
                            ...
                            <div class="col-xs-6 22" style="position: relative;width:49%;">
                                <input type="text" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" name="query[birth_end]" value="" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover"
                           data-operate-edit="<?php echo $auth->check('owners/index/edit'); ?>"
                           data-operate-del="<?php echo $auth->check('owners/index/del'); ?>"
                           width="100%">
                    </table>
                </div>
            </div>
